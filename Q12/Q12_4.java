...
/**
 * Java言語プログラミングレッスン 下 p74問題12-4 [問題分]
 * 次の機能を持つPlaceRectangleを、Rectangleのサブクラスとして宣言してください。 - 位置を示すint型のフィールドx, yを持つ -
 * 3つのコンストラクタを持つ 1.引数なし 2.位置付き 3.位置と大きさ付き - 位置を変更するメソッドsetLocationを持つ -
